...
const translations = {
  en: {
    ...
    aboutMe: 'About Me',
    projects: 'Projects',
    frontendDeveloper: 'Systems Development Technician',
    education: 'Education',
    ...
    introduction: "Hello, I'm Matheus Yokoo – Front-end Developer",
    ...
    experienciaOne: "For two years, I worked on projects that simulated a real development environment, applying market practices. I gained experience with versioning, teamwork and code problem-solving.",
  },
  'pt-br': {
    home: 'Início',
    aboutMe: 'Sobre mim',
    projects: 'Projetos',
    frontendDeveloper: 'Técnico em Desenvolvimento de Sistemas',
    education: 'Formação',
    downloadCv: 'Download CV',
    english: 'Inglês',
    ...
    introduction: "Olá, Sou Matheus Yokoo – Desenvolvedor Front-end",
    ...
    experienciaOne: "Durante dois anos, atuei em projetos que simulavam um ambiente real de desenvolvimento, aplicando práticas do mercado. Ganhei experiência com versionamento, trabalho em equipe e resolução de problemas no código.",
